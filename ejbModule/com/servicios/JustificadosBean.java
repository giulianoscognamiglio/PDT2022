...
public class JustificadosBean implements JustificadosBeanRemote {
	...
	public List<Justificado> obtenerTodos() {
		// TODO Auto-generated method stub
		TypedQuery<Justificado> query = em.createNamedQuery("Justificado.obtenerTodos", Justificado.class);
		return query.getResultList();
	}

	@Override
	public List<Justificado> obtenerTodos(String filtro) {
		// TODO Auto-generated method stub
		TypedQuery<Justificado> query = em
				.createQuery("SELECT j FROM Justificado j WHERE j.nombre LIKE :nombre", Justificado.class)
